...
//#[test]
fn custom_json() {
    let s = r#"{"secs":120,"nanos":309820}"#;
    println!("{}", s);
    let d: Duration = serde_json::from_str(&s).unwrap();
    println!("secs={},nanos={}",d.secs, d.nanos);
}

// #[test]
// fn test_simple_list() {
//     use mc_render::mcdata::blockstate::simple_list::*;
//     use rand::Rng;
//     use std::ptr::NonNull;

//     let mut rng = rand::thread_rng();
//     let mut head = ListNodeHeadNotNull::new_with_value((0, 100.0));
//     for i in 1..20 {
//         let f = rng.gen::<f64>();
//         head.push((i, f));
//     }
//     for m in ListNodeIter::from(&head) {
//         println!("{}: {}", m.0, m.1)
//     }

//     assert_eq!( std::mem::size_of::<ListNode<usize>>(), std::mem::size_of::<usize>() * 2);
// }
